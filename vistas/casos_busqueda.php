...
<body class="solicitud-body">
    ...
    <div class="header-right">
      ...
      <a href="<?= BASE_URL ?>/casos_lista"><button class="nav-btn"><i class="fa fa-arrow-left"></i> Volver atrás</button></a>
    </div>
  </header>
<main>
        <form action="<?=BASE_URL?>/casos_formulario" method="POST" class="registro-card form-user" autocomplete="off">
